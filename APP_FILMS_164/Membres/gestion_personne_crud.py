...
def personne_afficher(order_by, id_genre_sel):
        ...
        try:
            with DBconnection() as mc_afficher:
                ...
                if not data_genres and id_genre_sel == 0:
                    ...
                    flash(f"Personne affichés avec succès", "success")
    ...
    return render_template("membre/personne_afficher.html", data=data_genres)
...
def personne_ajouter_wtf():
    ...
    if request.method == "POST":
        try:
            if form.validate_on_submit():
                name_personne_wtf = form.nom_genre_wtf.data
                name_personne = name_personne_wtf.lower()
                valeurs_insertion_dictionnaire = {"value_intitule_genre": name_personne}
                print("valeurs_insertion_dictionnaire ", valeurs_insertion_dictionnaire)

                strsql_insert_genre = """INSERT INTO t_personne (id_personne,nom_personne) VALUES (NULL,%(value_intitule_personne)s) """
    ...
    return render_template("membre/personne_ajouter_wtf.html", form=form)
...
def personne_update_wtf():
    ...
    try:
        ...
        if form_update.validate_on_submit():
            ...
            str_sql_update_intitulegenre = """UPDATE t_personne SET nom_personne = %(value_name_genre)s WHERE id_personne = %(value_id_genre)s """
            with DBconnection() as mconn_bd:
            ...
            str_sql_id_genre = "SELECT id_personne, nom_personne FROM t_personne " \
    ...
    return render_template("membre/personne_update_wtf.html", form_update=form_update)
    ...
    try:
        ...
        if request.method == "POST" and form_delete.validate_on_submit():
            ...
            if form_delete.submit_btn_del.data:
                ...
                str_sql_delete_films_genre = """DELETE FROM t_personne_avoir_adresse WHERE fk_adresse = %(value_id_genre)s"""
        ...
        if request.method == "GET":
            ...
            str_sql_genres_films_delete = """SELECT * FROM t_personne_avoir_adresse 
                                            INNER JOIN t_personne ON t_personne_avoir_adresse.fk_adresse = t_personne.id_personne
                                            INNER JOIN t_personne ON t_personne_avoir_adresse.fk_adresse = t_personne.id_personne
            ...
            with DBconnection() as mydb_conn:
                ...
                # Opération sur la BD pour récupérer "id_genre" et "intitule_genre" de la "t_genre"
                str_sql_id_genre = "SELECT id_personne, nom_personne FROM t_personne WHERE id_personne = %(value_id_genre)s"

                mydb_conn.execute(str_sql_id_genre, valeur_select_dictionnaire)
                # Une seule valeur est suffisante "fetchone()",
                # vu qu'il n'y a qu'un seul champ "nom genre" pour l'action DELETE
                data_nom_genre = mydb_conn.fetchone()
                print("data_nom_genre ", data_nom_genre, " type ", type(data_nom_genre), " personne ",
                      data_nom_genre["nom_personne"])
